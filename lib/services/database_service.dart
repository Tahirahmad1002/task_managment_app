...
class DatabaseService {
  ...
  // 1. ADD TASK
  // 1. UPDATED ADD TASK
  Future<void> addTask(String userId, String title, String description, String category) async {
  ...
  Future<void> updateTaskDetails(String userId, String taskId, String newTitle, String newDesc, String newCat) async {
  await _db.collection('users').doc(userId).collection('tasks').doc(taskId).update({
    "title": newTitle,
    "description": newDesc,
    "category": newCat,
